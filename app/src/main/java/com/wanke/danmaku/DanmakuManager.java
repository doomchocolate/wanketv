...
public class DanmakuManager {
    ...
    DanmakuGlobalConfig mDanmakuConfig = new DanmakuGlobalConfig();
    ...
    public DanmakuManager setsparency(int transparency) {
        DanmakuGlobalConfig.DEFAULT.isTranslucent = true;
        DanmakuGlobalConfig.DEFAULT.transparency = transparency;
        return this;
    }
     ...
     * 默认弹幕文字的颜色
     */
    private int mDefaultDanmakuTextColor = Color.argb(255, 255, 255, 255);
    ...
    public DanmakuManager setTextColor(int color) {
        mDefaultDanmakuTextColor = Color.argb(color, 255, 255, 255);

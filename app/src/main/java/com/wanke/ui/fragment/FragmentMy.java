...
public class FragmentMy extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        StatService.onEvent(getActivity(), "109001", "my.fragment", 1);
    ...
    public void onClick(View view) {
        ...
        case R.id.my_aboutus:
            ...
            StatService.onEvent(getActivity(), "109012", "my.fragment", 1);
            break;
        ...
        case R.id.my_setting:
            ...
            startActivity(intent);
            StatService.onEvent(getActivity(), "109010", "my.fragment", 1);
            break;
        ...
        case R.id.my_information:
            if (!mHaveAccount) {
                ...
                intent.putExtra(InformationActivity.KEY_UID,
                        PreferenceUtil.getUid());
                startActivity(intent);
                StatService.onEvent(getActivity(), "109004", "my.fragment", 1);
            }
        ...
        case R.id.my_history:
            if (!mHaveAccount) {
                ...
                startActivity(intent);
                StatService.onEvent(getActivity(), "109008", "my.fragment", 1);
            }
        ...
        case R.id.my_fav:
            if (!mHaveAccount) {
                ...
                startActivity(intent);
                StatService.onEvent(getActivity(), "109002", "my.fragment", 1);
            }

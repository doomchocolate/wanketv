...
public class PreferenceUtil {
    ...
    private final static String PREFERENCE_NAME2 = "config2";
    ...
    public static int getLuminanceAlpha() {
        SharedPreferences sp = WankeTVApplication.getCurrentApplication()
                .getSharedPreferences(PREFERENCE_NAME2, 0);
        return sp.getInt(KEY_DANMAKU_SETTING_ALPHA, 0xFF);
    }

    public static void setLuminanceAlpha(int alpha) {
        SharedPreferences sp = WankeTVApplication.getCurrentApplication()
                .getSharedPreferences(PREFERENCE_NAME2, 0);
        Editor editor = sp.edit();
        editor.putInt(KEY_DANMAKU_SETTING_ALPHA, alpha);
